...
| Sections 1 | Sections 2 | Sections 3 | Sections 3 |
|:----------|:----------|:----------|:----------|
| S3  | EC2  | Global Accelerator| CloudFront|
| ASG | ELB  | Containers - ECS | Encryption |
| SNS | SQS  |  Databases| Analytics  |
| VPC | Kinesis | CloudWatch | CloudTrail |
...
|4|EC2               |Elastic Compute Cloud (EC2) is a highly configurable virtual server. EC2 is resizable compute capacity. It takes minutes to launch new instances. Anything and everything on AWS uses EC2 Instance underneath. Instance types comprise varying combinations of CPU, memory, storage, and networking capacity and give you the flexibility to choose General Purpose(M,T), Compute Optimized (C), Memory Optimized(R,X), Accelerated Computing(P,G), Storage Optimized(I,D), HPC Optimized(HPC). |
